    ...
    public function add(){
    	if($this->input->post()){
    		...
    		if($this->form_validation->run() == TRUE){
                $data['post_data'] = $this->mycommonlib->Filter_Field($data['post_data'], array('title', 'alias', 'image', 'content', 'parentid', 'description', 'meta_keyword', 'meta_description', 'meta_title', 'price', 'sale_price', 'brand_id', 'publish', 'is_featured', 'show_price', 'fb_share_like', 'fb_comment'));
