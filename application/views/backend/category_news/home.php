        ...
        <div class="panel-body">
	        <div class="col-lg-12" style="padding-bottom: 10px;">
				...
				<div class="col-md-8 text-right">
                    ...
                    <a href="<?php echo CMS_DEFAULT_BACKEND_URL?>/category_news/add" class="btn btn-success">Thêm mới</a>
				</div>
			</div>
            <div class="col-lg-12">
            <?php
			...
			?>
					<table class="table table-striped">
						<tr>
							...
							<th><?php echo get_sort_link(uri_string(), 'Tiêu đề', 'title', '', array('keyword' => $keyword));?></th>
                            <th>Người tạo</th>
                            <th><?php echo get_sort_link(uri_string(), 'Vị trí', 'order', '', array('keyword' => $keyword));?></th>
                    ...
                    ?>
                        <tr>
							...
							<td style="text-align: left;"><?php echo isset($tree_data[$val['id']]) ? $tree_data[$val['id']] : 0?></td>
							...
							<td><a href="<?php echo CMS_DEFAULT_BACKEND_URL?>/category_news/category_news_toggle/publish/<?php echo $val['id'].'/?redir='.base64_encode(current_url().'?'.$_SERVER['QUERY_STRING']);?>"><span class="glyphicon glyphicon-eye-<?php echo ($val['publish'] == 1) ? 'open' : 'close'?>"></span></a></td>
							...
							<td><a href="<?php echo CMS_DEFAULT_BACKEND_URL.'/category_news/edit/'.$val['id'].'/?redir='.base64_encode(current_url().'?'.$_SERVER['QUERY_STRING']);?>" title="Sửa"><span class="glyphicon glyphicon-pencil"></span></a></td>
							<td><a href="<?php echo CMS_DEFAULT_BACKEND_URL.'/category_news/del/'.$val['id'].'/?redir='.base64_encode(current_url().'?'.$_SERVER['QUERY_STRING']);?>" onclick="return confirm('Bạn có chắc là muốn xóa bản ghi này không ?')" title="Xóa"><span class="glyphicon glyphicon-trash"></span></a></td>
						</tr>
                    <?php
                            }
                        }else{
