<div class="col-md-12 text-justify" style="border-top: 1px #afafaf solid;">
    ...
    <ol class="breadcrumb" style="background: #d8d8d8; margin-top:20px;">
        ...
        <li><a href="<?php echo CMS_DEFAULT_BACKEND_URL?>/category_news">Categories</a></li>
        ...
        <div class="panel-body">
            ...
            <div class="col-md-12 item">
                ...
                <div class="col-md-9">
                    ...
                    <input type="button" class="btn btn-success" value="Browse Server" onclick="BrowseServer( 'Files:/', 'image' );" />
                </div>

                <?php if(isset($post_data['image']) && $post_data['image'] != ''):?>
                    <div class="col-md-3" style="line-height: 200%;"></div>
                    <div class="col-md-9" style="margin: 10px 0px;">
                        <img style="width:150px;" class="img-responsive img-thumbnail" src="<?php echo $post_data['image']?>" alt=""/>
                    </div>
                <?php endif;?>
            </div>
            ...
            <div class="col-md-12 item">
                ...
                <div class="col-md-9 item">
                    ...
                    <?php
                        foreach($list_category_news as $key => $val){
                    ?>
