<div class="col-md-12 text-justify" style="border-top: 1px #afafaf solid;">
    ...
    <div class="panel panel-default">
        <div class="panel-heading">
            <h3 class="panel-title">Sửa bài đăng</h3>
        </div>
            ...
            <div id="others" class="hidden tabs-item">
                ...
                <div class="col-md-12 item">
                    ...
                    <div class="col-md-9">
                        ...
                        <label>Không <input type="radio" name="is_featured" class="" value="0" <?php echo (isset($post_data['is_featured']) && $post_data['is_featured'] == 0 || !isset($post_data['publish'])) ? 'checked' : ''?> /></label>
                    </div>
                </div>
            </div>
