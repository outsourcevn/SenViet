        ...
        <div class="panel-body">
	        <div class="col-lg-12" style="padding-bottom: 10px;">
				...
				<div class="col-md-8 text-right">
                    ...
                    <a href="<?php echo CMS_DEFAULT_BACKEND_URL?>/brand/add" class="btn btn-success">Thêm mới</a>
				</div>
			</div>
            <div class="col-lg-12">
            <?php
			...
			?>
					<table class="table table-striped">
						<tr>
							...
							<th><?php echo get_sort_link(uri_string(), 'Tiêu đề', 'brand_name', '', array('keyword' => $keyword));?></th>
                            <th>Người tạo</th>
                    ...
                    ?>
                        <tr>
							...
							<td><a href="<?php echo CMS_DEFAULT_BACKEND_URL?>/brand/brand_toggle/publish/<?php echo $val['id'].'/?redir='.base64_encode(current_url().'?'.$_SERVER['QUERY_STRING']);?>"><span class="glyphicon glyphicon-eye-<?php echo ($val['publish'] == 1) ? 'open' : 'close'?>"></span></a></td>
							...
							<td><a href="<?php echo CMS_DEFAULT_BACKEND_URL.'/brand/edit/'.$val['id'].'/?redir='.base64_encode(current_url().'?'.$_SERVER['QUERY_STRING']);?>" title="Sửa"><span class="glyphicon glyphicon-pencil"></span></a></td>
							<td><a href="<?php echo CMS_DEFAULT_BACKEND_URL.'/brand/del/'.$val['id'].'/?redir='.base64_encode(current_url().'?'.$_SERVER['QUERY_STRING']);?>" onclick="return confirm('Bạn có chắc là muốn xóa bản ghi này không ?')" title="Xóa"><span class="glyphicon glyphicon-trash"></span></a></td>
						</tr>
                    <?php
                            }
                        }else{
