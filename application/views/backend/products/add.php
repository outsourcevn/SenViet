<div class="col-md-12 text-justify" style="border-top: 1px #afafaf solid;">
    ...
    <ol class="breadcrumb" style="background: #d8d8d8; margin-top:20px;">
        ...
        <li class="active">Thêm Products</li>
    </ol>
    
    <?php echo form_open('')?>
        <div class="panel panel-default">
            <div class="panel-heading">
                <h3 class="panel-title">Thêm Product</h3>
            </div>
            ...
            <div class="panel-body">
                ...
                <div id="common" class="tabs-item">
                    ...
                    <div class="col-md-12 item">
                        ...
                        <div class="col-md-9"><input id="sale_price" name="sale_price" class="form-control" type="number" title="Giá khuyến mại" value="<?php echo (isset($post_data['sale_price'])? $post_data['sale_price'] : '')?>" /></div>
                    </div>
