    ...
    <div class="container">
        ...
        <div class="navbar-collapse collapse" id="navbar">
            ...
            <ul class="nav navbar-nav navbar-right">
                <li><a href="http://login.senvietgroup.vn/">Đăng Nhập</a></li>
                <li>
...
<header>
    <div class="container">
        ...
        <div class="login-dialog pull-right hidden-sm hidden-xs col-lg-1">
            <button class="btn btn-success" type="button" name="login-btn" onclick="location.href='http://login.senvietgroup.vn'">&nbsp;&nbsp;&nbsp;&nbsp;<i class="fa fa-user"></i>&nbsp;&nbsp;&nbsp;&nbsp;<br>&nbsp;&nbsp; &nbsp;&nbsp;Đăng nhập&nbsp;&nbsp;&nbsp;&nbsp;</button>
        </div>
        <!--/Login Area-->
